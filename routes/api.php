...
use App\Http\Controllers\{ UserController, SubscriptionController, EmailController, AuthController, StripeController, NewsController, DiscountController };
...
Route::get("/discounts/{id}", [DiscountController::class, 'discount']);